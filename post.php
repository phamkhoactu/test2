...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            $send_query = mysqli_query($cnn,$view_query);   
            ...
            while ($row = mysqli_fetch_assoc($select_all_posts_query)) {
                ...
                if (isset($_POST['create_comment'])) {
                   ...
                   $create_comment_query = mysqli_query($cnn,$query);
                   ...
                   // $update_comment_query = mysqli_query($cnn,$query);
                   } else {
        ...
        <?php 
         ...
         $query .= " AND comment_status='approved' ORDER BY comment_id DESC";
            $select_all_comments_query = mysqli_query($cnn,$query);
