...
if(isset($_POST['create_post'])){
	...
	$create_post_query = mysqli_query($cnn,$query);
	confirm($create_post_query);
	$the_post_id = mysqli_insert_id($cnn);
	echo "<p class='bg-success'>Post Created:<a href='../post.php?post_id={$the_post_id}'>View Post</a> or <a href='posts.php'>Edit More Posts</a></p>";
}
?>
